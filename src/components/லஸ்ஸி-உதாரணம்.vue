          ...
          <v-row>
            <v-col cols="4">
              <v-select
                :items="நிரல்மொழிகள்"
                v-model="நிரல்மொழி"
                :label="$மொ('அறிமுகம்.உதாரணம்.நிரல்_மொழி')"
                hide-no-data
                variant="outlined"
                density="compact"
                color="secondary"
            ...
            <v-col cols="4">
              <v-select
                ...
                v-model="உள்_மொழி"
                :label="$மொ('அறிமுகம்.உதாரணம்.மூல்_மொழி')"
                hide-no-data
                variant="outlined"
                density="compact"
                hide-details
            ...
            <v-col cols="4">
              <v-select
                ...
                :label="$மொ('அறிமுகம்.உதாரணம்.எண்ணுரு')"
                hide-no-data
                variant="outlined"
                density="compact"
                hide-details
          ...
          <v-row>
            ...
            <v-col cols="4">
              <v-select
                :items="நிரல்மொழியின்_மொழிகள்"
                v-model="வெள்_மொழி"
                :label="$மொ('அறிமுகம்.உதாரணம்.வேண்டிய_மொழி')"
                hide-no-data
                variant="outlined"
                density="compact"
                hide-details
    ...
    <v-row v-if="லஸ்ஸி_தயாரானது" class="text-center mt-0">
      <v-col cols="6">
        <v-textarea
          ...
          :no-resize="true"
          :label="$மொ('அறிமுகம்.உதாரணம்.உள்ளீடு')"
      ...
      <v-col cols="6">
        <v-textarea
          ...
          :no-resize="true"
          :label="$மொ('அறிமுகம்.உதாரணம்.வெளியீடு')"
      ...
      <v-col v-if="லஸ்ஸி_கிடையாது" cols="12">
        <v-card flat class="text-center py-6">
          <v-img
           ...
           contain
          ></v-img>
          <h2>{{ $மொ('அறிமுகம்.உதாரணம்.லஸ்ஸி_கிடையாது') }}</h2>
          <p>{{ $மொ('அறிமுகம்.உதாரணம்.லஸ்ஸி_கிடையாது_துணை') }}</p>
        </v-card>
      </v-col>
      <v-col v-else cols="12">
        <v-card flat class="text-center py-6">
          <v-img
           ...
           contain
          ></v-img>
          <h2>{{ $மொ('அறிமுகம்.உதாரணம்.லஸ்ஸியை_ஏற்றுகிறது') }}</h2>
        </v-card>
        <v-progress-circular
          size="50"
          indeterminate
...
watchEffect(()=>{
  ...
  உள்_மொழி.value = நிரல்மொழியின்_மொழிகள்.value.includes(மொழி.value) ? மொழி.value : நிரல்மொழியின்_மொழிகள்.value[நிரல்மொழியின்_மொழிகள்.value.length - 1]
})
...
const எண்ணுரு_முறைமை_உருப்படிகள் = computed(()=>{
  return [
    {title: $மொ('அறிமுகம்.உதாரணம்.தனிப்பட்ட'), value: ""},
    ...எண்ணுரு_முறைமைகள்.value.map(இ => ({title: இ, value :இ}))
  ]
})
