<template>
  <v-card max-width="500">
    ...
    <v-card-subtitle>
      உங்கள் பயனாளர் அடையாளத்தை மாற்ற முடியாது என்றாலும், உங்கள் பெயர் மொழியாக்கங்களை உள்ளிடலாம்.
    </v-card-subtitle>
    <v-divider></v-divider>
    <v-list-item>
...
export default {
  ...
  methods: {
    seru (மொழி, பெயர்) {
      ...
      this.$கணக்கு.தத.பயனாளர்_பெயர்_சேரு(மொழி, பெயர்)
    },
    mattram (மொழி, பெயர்) {
      this.$கணக்கு.தத.பயனாளர்_பெயர்_சேரு(மொழி, பெயர்)
    },
    nikku(மொழி) {
      this.$கணக்கு.தத.பயனாளர்_பெயர்_நீக்கு(மொழி)
    },
