          ...
          <v-row class="text-center">
            ...
            <v-col cols="12">
              <v-row class="mx-0 mb-2">
                ...
                <v-spacer/>
                <v-btn outlined color="amber" @click="செல்லு(3)">
                  அடுத்து
                  <v-icon>mdi-arrow-right</v-icon>
                </v-btn>
              </v-row>
      ...
      <v-stepper-content :step="4">
        <v-row class="text-center">
          <v-col cols="12">
            ...
            <v-img
             :src="require('../../assets/உன்றா-பயனாளர்.svg')"
             max-height="150"
             contain
             class="ma-10"
            ></v-img>
            <v-row>
              <v-col cols="6">
                <v-text-field
                 v-model="பயனாளர்பெயர்"
                 label="பயனாளர் பெயர் உள்ளிடுங்கள்"
                 outlined
                 color="amber darken-2"
                >
                </v-text-field>
...
export default {
  ...
  methods: {
    ...
    உள்ளிடு_அழைப்பு () {
      ...
      this.$கணக்கு.உள்ளிடு_அழைப்பு(அழைப்பு, this.பயனாளர்பெயர், this.சாதனம்பெயர்)
    },
    உள்ளிடு_புதுகணக்கு () {
      this.$கணக்கு.பயனாளர்_உருவாக்கி(this.பயனாளர்பெயர், this.சாதனம்பெயர்)
    }
  }
}
</script>
