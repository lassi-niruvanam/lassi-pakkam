...
import NiralmozhiMempatu from "@/components/நிரல்மொழி_மேம்பாடு.vue"
const nuchabäl = new Nuchabäl({});
const இலக்கணங்கள் = new லஸ்ஸி_இலக்கணங்கள்({});

const{ நிரல்மொழிகள்} = லஸ்ஸியை_பயன்படுத்து();
